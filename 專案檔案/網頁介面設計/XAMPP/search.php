...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
    $stores = searchStores($location, $adjective, $keyword);
}
    ...
    <div class="accordion-item">
        ...
        <div id="panelsStayOpen-collapse" class="accordion-collapse collapse show" style="overflow: scroll; overflow-x: hidden; max-height: 34vh;">
            <?php foreach ($stores as $index => $store): ?>
                <div class="accordion-body" style="background-color: #E7EAEE; margin: 0.625em; border-radius: 15px;" data-name="<?php echo htmlspecialchars($store["name"]); ?> "onclick="navigateToDetail(this);">
                        ...
                        <div class="progress" role="progressbar" aria-label="Success example" aria-valuenow="25"
                          ...
                          <div class="progress-bar "
                                style="width: <?php echo htmlspecialchars(
                                    $store["real_rating"]
                                ); ?>%; background-color: #B45F5F; text-align: left; padding-left: 0.625em; font-size: 0.8em;">
                                <?php echo htmlspecialchars(
                                    $store["real_rating"]
                                ); ?>%</div><!--填入"熱門指數"width也要跟著改-->
                            </div>
                            <div class="progress" role="progressbar" aria-label="Success example" aria-valuenow="25"
                              aria-valuemin="0" aria-valuemax="100"
                              ...
                              <div class="progress-bar "
                                style="width: <?php echo htmlspecialchars(
                                    $store["environment_rating"]
                                ); ?>%; background-color: #562B08; text-align: left; padding-left: 0.625em; font-size: 0.8em;">
                                <?php echo htmlspecialchars(
                                    $store["environment_rating"]
                                ); ?>%</div><!--填入"環境指數"width也要跟著改-->
                            </div>

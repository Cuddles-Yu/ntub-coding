<?php  
  ...
  if ($_SERVER["REQUEST_METHOD"] == "POST") {
    ...
    $stmt = bindPrepare($conn, "
      UPDATE preferences
      SET search_radius=?, will_open=?, open_now=?, will_close=?, close_now=?, parking=?, wheelchair_accessible=?, vegetarian=?, healthy=?, 
    ...
    ", "isssssssssssssssssssssssssssi",
      $searchRadius, $willOpen, $openNow, $willClose, $closeNow, $parking, $wheelchairAccessible, $vegetarian, $healthy, 
